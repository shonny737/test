...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Все счета по клиенту " + client3.getName() + ": " + bank.getAccounts(client3));
        System.out.println("Найти клиента по счету " + account2.getCoin() + ": " + bank.findClient(account2));
        System.out.println("Список всех клиентов банка: " + bank.getClients());
    }
}